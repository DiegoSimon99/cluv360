...
export const Index = () => {
  ...
  useEffect(() => {
    const fetchTemplate = async () => {
      try {
        const response = await apiClient.get(`/admin/template/inversion`);
            ...
            <div className="container">
              <div className="header">
                ...
                <h1
                  ...
                  onBlur={(e) => updateText("inversion-titulo", e.target.innerText)}
                >
                  {template["inversion-titulo"]}
                </h1>
                <p
                  contentEditable="true"
                  suppressContentEditableWarning={true}
                  onBlur={(e) => updateText("inversion-subtitulo", e.target.innerText)}
                >
                  {template["inversion-subtitulo"]}
                </p>
                <img src="https://apis.cluv360.com/mails/inversion/header.png" className="banner" alt="Yala Logo" />
              </div>
              ...
              <div className="content">
                <p
                  ...
                  contentEditable="true"
                  suppressContentEditableWarning={true}
                  onBlur={(e) => updateText("inversion-saludo", e.target.innerText)}
                >
                  {template["inversion-saludo"]}
                </p>
                ...
                <p
                  ...
                  contentEditable="true"
                  suppressContentEditableWarning={true}
                  onBlur={(e) => updateText("inversion-text", e.target.innerText)}
                >
                  {template["inversion-text"]}
                </p>
                ...
                <p
                  ...
                  contentEditable="true"
                  suppressContentEditableWarning={true}
                  onBlur={(e) => updateText("inversion-descripcion", e.target.innerText)}
                >
                  {template["inversion-descripcion"]}
                </p>
                <div className="image-content">
                  <img
                    src={getYouTubeThumbnail(template["inversion-link-1"])}
                    className="photo"
                    ...
                    <div className="modal-body">
                      <div className="row g-2">
                        <div className="col-12 mb-2">
                          {!template["inversion-link-1"] ? (
                            <p className="text-center">Cargando enlace...</p>
                          ) : (
                            <label
                              contentEditable="true"
                              suppressContentEditableWarning={true}
                              onBlur={(e) => updateText("inversion-link-1", e.target.innerText)}
                              style={{ width: "100%" }}
                            >
                              {template["inversion-link-1"]}
                            </label>

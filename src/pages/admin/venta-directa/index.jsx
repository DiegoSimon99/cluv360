...
export const Index = () => {
  ...
  const listVentas = () => {
    ...
    apiClient
      .post(`admin/direct-sale?page=${currentPage}`, data)
      .then((response) => {
  ...
  const fetchCustomers = async (inputValue) => {
    try {
      const response = await apiClient.get(`admin/direct-sale/list_user_direct_sale?search=${inputValue}`);
      if (response.data.success) {
  ...
  return (
    <>
      <div className="card">
        <div className="card-header align-items-center row">
          ...
          <div className="col-12 col-md-2 mb-4">
            <button type="button" className="btn btn-primary w-100" onClick={() => handleShowChangeVenta()}>
              {" "}
              Nueva Venta
            </button>
          </div>
          ...
          <div className="col-12 col-md-2 mb-2">
            ...
            <input type="date" className="form-control" onChange={handleFilterFechaInicioChange} />
          </div>
          <div className="col-12 col-md-2 mb-2">
            <label>Fecha Fin</label>
            <input type="date" className="form-control" onChange={handleFilterFechaFinChange} />
          </div>
          <div className="col-12 col-md-2 mb-2">
            <br />
        ...
        <div className="table-responsive text-nowrap pt-2 ps-4 pe-4">
          <table className="table table-hover">
            ...
            <tbody className="table-border-bottom-0 position-relative">
              <LoaderTable loading={loading} cantidad={ventas.length}></LoaderTable>
      ...
      <Modal show={showChangeVenta} onHide={handleCloseChangeVenta} centered>
                ...
                <form onSubmit={handleSubmitVenta}>
                  <div className="row g-2">
                    <div className="col-12 mb-2">
                      <label className="form-label">CLIENTE QUE RECIBE LA VENTA</label>
                      <AsyncSelect

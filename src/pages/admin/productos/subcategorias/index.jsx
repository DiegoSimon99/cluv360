...
export const Index = () => {
    ...
    const listSubCategorias = () => {
        ...
        apiClient.post(`admin/subcategories?page=${currentPage}`, data)
            .then(response => {
    ...
    const createSubCategoria = (e) => {
        navigate('/admin/subcategories/create');
    }

    const editSubCategoria = (id) => {
        navigate(`/admin/subcategories/edit/${id}`);
    }
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            ...
                            showNotification(error.response?.data?.message || "Error al eliminar subcategoría", 'error');
                        } finally {
                            hideLoading();
                        }
                    }
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">SubCategorías</h5>
                    </div>
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-menu">
                                                <button
                                                    ...
                                                    href="#"
                                                    onClick={() => editSubCategoria(item.id)}
                                                >
                                                ...
                                                <button
                                                    aria-label="dropdown action option"
                                                    className="dropdown-item"
                                                    onClick={() => deleteSubCategoria(item.id)}
                                                >

...
export const Index = () => {
    ...
    const listMarcas = () => {
        ...
        apiClient.post(`admin/brands?page=${currentPage}`, data)
            .then(response => {
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            ...
                            showNotification(error.response?.data?.message || "Error al eliminar marca", 'error');
                        } finally {
                            hideLoading();
                        }
                    }
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">Marcas</h5>
                    </div>

...
export const Edit = () => {
    ...
    useEffect(() => {
        ...
        apiClient.get(`/admin/brands/${id}`)
            ...
            .catch((error) => {
                showNotification(error.response?.data?.message || "Error al obtener marca", 'error');
            })
            .finally(() => {
                setIsLoading(false);
            });
    ...
    const handleSubmit = async (e) => {
        ...
        apiClient.post(`/admin/brands/${id}`, data)
            ...
            .catch((error) => {
                showNotification(error.response?.data?.message || "Error al actualizar marca", 'error');
            })
            .finally(() => {
                setLoading(false);
            });
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">Información de marca</h5>
                    </div>
                </div>

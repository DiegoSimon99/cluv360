...
export const ListaCustomers = () => {
  ...
  return (
    <>
        ...
        <div className="table-responsive text-nowrap pt-2 ps-4 pe-4">
          <table className="table table-hover">
            ...
            <tbody className={`table-border-bottom-0 ${loading ? "position-relative" : ""}`}>
              <LoaderTable loading={loading} cantidad={customers.length}></LoaderTable>
            ...
            <div className="modal-body">
              {saldo === null ? (
                ...
                <div className="row g-2">
                  <ModalInput items={saldo}></ModalInput>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {user === null ? (
                ...
                <div className="row g-2">
                  <ModalInput items={user}></ModalInput>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {patrocinador === null ? (
                ...
                <div className="row g-2">
                  <ModalInput items={patrocinador}></ModalInput>
                </div>
              )}
            </div>
          </div>
      ...
      <Modal show={showResetPassword} onHide={handleCloseResetPassword} centered>
          ...
          <form onSubmit={handleSubmitPassword}>
            <div className="row g-2">
              ...
              <div className="col-12 col-md-6 mb-2">
                ...
                <button type="button" className="btn btn-secondary d-block w-100" onClick={handlePasswordStatic}>
                  12345678
                </button>
              </div>
      ...
      <Modal show={showChangePatrocinador} onHide={handleCloseChangePatrocinador} centered>
        <Modal.Header closeButton>

...
export const Index = () => {
    ...
    const listNoticias = () => {
        ...
        apiClient.post(`admin/config/noticias?page=${currentPage}`, data)
            .then(response => {
    ...
    const createNoticia = (e) => {
        navigate('/admin/config/noticias/create');
    }

    const editNoticia = (id) => {
        navigate(`/admin/config/noticias/edit/${id}`);
    }
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            showLoading();
                            const response = await apiClient.delete(`/admin/config/noticias/${id}`);
                            ...
                            showNotification(error.response?.data?.message || "Error al eliminar evento", 'error');
                        } finally {
                            hideLoading();
                        }
                    }
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">Noticias</h5>
                    </div>
                    <div className="col-12 col-md-2 mb-4">
                        <button
                            type="button"
                            className="btn btn-primary w-100"
                            onClick={() => createNoticia()}
                        > Nueva Noticia
                        </button>
                    </div>

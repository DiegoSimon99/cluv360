...
export const Create = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (photos.photo2) {
            data.append("photo_lugar", photos.photo2);
        }
        ...
        setLoading(true);
        apiClient.post(`/admin/config/eventos/store`, data)
            .then(response => {
            ...
            .catch((error) => {
                showNotification(error.response?.data?.message || "Error al guardar evento", 'error');
            })
            .finally(() => {
                setLoading(false);
            });

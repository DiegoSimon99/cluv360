...
export const Index = () => {
    ...
    const listEventos = () => {
        ...
        apiClient.post(`admin/config/eventos?page=${currentPage}`, data)
            .then(response => {
    ...
    const createEvento = (e) => {
        navigate('/admin/config/eventos/create');
    }

    const editEvento = (id) => {
        navigate(`/admin/config/eventos/edit/${id}`);
    }
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            showLoading();
                            const response = await apiClient.delete(`/admin/config/eventos/${id}`);
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">Eventos</h5>
                    </div>

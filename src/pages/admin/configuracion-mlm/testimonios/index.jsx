...
export const Index = () => {
    ...
    const listTestimonios = () => {
        ...
        apiClient.post(`admin/config/testimonios?page=${currentPage}`, data)
            .then(response => {
    ...
    const createTestimonio = (e) => {
        navigate('/admin/config/testimonios/create');
    }

    const editTestimonio = (id) => {
        navigate(`/admin/config/testimonios/edit/${id}`);
    }
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            showLoading();
                            const response = await apiClient.delete(`/admin/config/testimonios/${id}`);
                            ...
                            showNotification(error.response?.data?.message || "Error al eliminar testimonio", 'error');
                        } finally {
                            hideLoading();
                        }
                    }
            ...
            <div className="card">
                <div className="card-header align-items-center row">
                    <div className="col-12 col-md-10 pt-0 pt-md-2 mb-4">
                        <h5 className="mb-0 text-md-start text-center">Testimonios</h5>
                    </div>
                    <div className="col-12 col-md-2 mb-4">
                        <button
                            type="button"
                            className="btn btn-primary w-100"
                            onClick={() => createTestimonio()}
                        > Nuevo testimonio
                        </button>
                    </div>
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-menu">
                                                <button
                                                    ...
                                                    href="#"
                                                    onClick={() => editTestimonio(item.id)}
                                                >
                                                ...
                                                <button
                                                    aria-label="dropdown action option"
                                                    className="dropdown-item"
                                                    onClick={() => deleteTestimonio(item.id)}
                                                >

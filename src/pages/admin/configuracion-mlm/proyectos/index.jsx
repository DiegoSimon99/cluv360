...
export const Index = () => {
    ...
    const listProyectos = () => {
        ...
        apiClient.post(`admin/config/proyectos?page=${currentPage}`, data)
            .then(response => {
    ...
    const createProyecto = (e) => {
        navigate('/admin/config/proyectos/create');
    }

    const editProyecto = (id) => {
        navigate(`/admin/config/proyectos/edit/${id}`);
    }
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            showLoading();
                            const response = await apiClient.delete(`/admin/config/proyectos/${id}`);

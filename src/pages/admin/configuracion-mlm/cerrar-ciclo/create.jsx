...
export const Create = () => {
  ...
  const handleSubmitCierreCiclo = async (e) => {
    ...
    setLoading(true);
    apiClient
      .post(`/admin/config/cierre-ciclo/store`, formData)
      .then((response) => {
  ...
  const handleReloadRango = async (e) => {
    ...
    setIsLoading(true);
    apiClient
      .get(`/admin/config/cierre-ciclo/reload-rango`)
      .then((response) => {
        if (response.data.success) {
          showNotification(response.data.message, "success");
        } else {
        ...
        <div className="card-body">
          <form onSubmit={handleSubmitCierreCiclo}>
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-10">
                <select className="form-control" name="premio" value={formData.premio} onChange={handleChange} required>
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-10">
                <select className="form-control" name="rango" value={formData.rango} onChange={handleChange} required>
                  <option value="">SELECCIONE</option>
                  <option value="1">SI</option>
                  <option value="0">NO</option>
                </select>
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-10">
                <select className="form-control" name="pm_mes" value={formData.pm_mes} onChange={handleChange} required>
                  <option value="">SELECCIONE</option>
                  <option value="1">SI</option>
                  <option value="0">NO</option>
                </select>
